          ...
          >
            ...
            <v-list-tile-action @click.stop="">
              <v-menu bottom offset-y>
                ...
                <v-list>
                  <v-list-tile @click="deleteContract(i)">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      deleteContract: function(i){
        var self = this;
        if(i>=0 && i<self.contracts.length){
          self.contracts.splice(i, 1);
          window.localStorage.contracts = JSON.stringify(self.contracts);
        }
      },
      components: {
